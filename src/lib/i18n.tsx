...
const de: Dict = {
  ...
  copied: "Kopiert",
  snapToGuides: "Ausrichtungslinien / Fangnetz",
  ...
  feedbackDesc: "Teile uns deine Wünsche, Ideen, Bugs oder Kritik mit.",
  category: "Kategorie",
  wish: "Wunsch",
  bug: "Fehler / Bug",
  uiImp: "UI Verbesserung",
  critique: "Kritik",
  other: "Sonstiges",
  feedbackPlaceholder: "Beschreibe dein Feedback möglichst genau...",
  submitFeedback: "Feedback abschicken",
  sendingFeedback: "Sende Feedback...",
  ...
  fetchFeedback: "Feedbacks laden",
  noFeedbackFound: "Noch kein Feedback vorhanden.",
  confirmDeleteFeedback: "Feedback wirklich löschen?",
};
...
const en: Dict = {
  ...
  feedbackDesc: "Share your feature wishes, ideas, bugs, or critique with us.",
  category: "Category",
  wish: "Wish / Feature",
  bug: "Bug / Issue",
  uiImp: "UI Improvement",
  critique: "Critique",
  other: "Other",
  ...
  adminApiKey: "Admin API Key",
  fetchFeedback: "Fetch Feedbacks",
  noFeedbackFound: "No feedback items yet.",
  confirmDeleteFeedback: "Delete this feedback item?",
};

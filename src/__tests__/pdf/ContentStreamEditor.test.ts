...
import { tokenizeStream, filterRedactedText, createInitialGraphicsState } from '../../lib/pdf/ContentStreamEditor';
...
describe('ContentStreamEditor', () => {
  ...
  test('Redact-Filter: Zeichen in Box → entfernt, Zeichen außerhalb → bleibt', () => {
    ...
    let redacted = filterRedactedText(tokens, [{x: 90, y: 90, x2: 200, y2: 120}], undefined, state);
